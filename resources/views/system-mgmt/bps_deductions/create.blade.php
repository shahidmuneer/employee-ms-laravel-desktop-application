    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add new bps Deduction</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('bps_deduction.store') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Bps Deductions Name</label>
                        ...
                        <div class="form-group{{ $errors->has('date_of_deduction') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                               <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('date_of_deduction') }}" name="date_of_deduction" class="form-control pull-right" id="date_of_deduction" required>
                                </div>
