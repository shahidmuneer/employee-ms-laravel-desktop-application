        ...
        <div class='container'>
            ...
            <thead>
              <tr role="row">
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending">Designation</th>
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Division: activate to sort column ascending">District</th>
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Division: activate to sort column ascending">Bps</th>          
            ...
            @foreach ($employees as $employee)
                <tr role="row" class="odd">
                  ...
                  <td class="hidden-xs">{{ $employee->designation->name }}</td>
                  <td class="hidden-xs">{{ $employee->department->name }}</td>
                  <td class="hidden-xs">{{ $employee->district->name }}</td>
