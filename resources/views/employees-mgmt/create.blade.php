                        ...
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @endif
                                        ...
                                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            <label for="zip" class="col-md-4 control-label">CNIC</label>

                            <div class="col-md-6">
                                <input id="cnic" type="number" class="form-control" placeholder="FORMAT: xxxxxxxxxxxxx" name="cnic" value="{{ old('cnic') }}" required>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="designation_id">
                                    @foreach ($designations as $designation)
                                        <option {{old('designation_id') == $designation->id ? 'selected' : ''}} value="{{$designation->id}}">{{$designation->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="bps_stage_id">
                                    @foreach ($stages as $stage)
                                        <option {{old('bps_stage_id') == $stage->id ? 'selected' : ''}} value="{{$stage->id}}">{{$stage->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
